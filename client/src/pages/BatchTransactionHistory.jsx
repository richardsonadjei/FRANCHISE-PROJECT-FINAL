...
const BatchTransactionReport = () => {
    ...
    useEffect(() => {
        const fetchBatches = async () => {
            try {
                ...
                // Extract batch numbers from the response data
    ...
    const generatePDF = () => {
        ...
        doc.autoTable({
            ...
            body: transactions.map((transaction) => [
                ...
                transaction.modifiedQuantity, // Include modifiedQuantity here
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(`/api/cocoabags/reports/transactions?batchNumber=${batchNumber}&startDate=${startDate}&endDate=${endDate}`);
        const data = await response.json();
