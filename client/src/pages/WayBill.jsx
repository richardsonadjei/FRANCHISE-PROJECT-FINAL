...
const Waybill = () => {
  ...
  const [generatedBy, setGeneratedBy] = useState(currentUser ? currentUser.username : '');
  ...
  const generatePDFReport = (waybillData) => {
    ...
    tableData.push(['Generated By', waybillData.generatedBy]);
...
<div className="mb-4">
  <label htmlFor="generatedBy" className="block text-sm font-medium text-gray-600">
    Generated By
  </label>
  <input
    type="text"
