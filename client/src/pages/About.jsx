...
const About = () => {
  return (
    <div className="bg-white py-12 sm:py-12 mx-auto overflow-y-auto max-h-screen mt-28 px-4">
        ...
        <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
          <li>
            <div className="flex items-center gap-x-6">
              ...
              <div>
                <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">Richardson Adjei</h3>
          ...
          <li>
            <div className="flex items-center gap-x-6">
              ...
              <div>
                <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">Grace Aidoo</h3>
                <p className="text-sm font-semibold leading-6 text-indigo-600">
                  Co-Founder / CEO
                  <br />
                  <span className="text-yellow-600 font-semibold">
                    Grace Aidoo is a dedicated leader known for her exceptional organizational skills and strategic thinking. With a background in business management, Grace plays a key role in shaping our company's growth and success.
                  </span>
                </p>
              </div>
            </div>
          ...
          <li>
            <div className="flex items-center gap-x-6">
              ...
              <div>
                <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">Mr Ahmed</h3>
                <p className="text-sm font-semibold leading-6 text-indigo-600">
                  Co-Founder / CEO
                  <br />
                  <span className="text-yellow-600 font-semibold">
